# -*- coding: utf-8 -*-
"""Dựng bộ slide tiếng Anh (.pptx trọn bộ) từ bộ tiếng Việt.

    python3 scripts/dich_deck_en.py            # báo còn thiếu chuỗi nào
    python3 scripts/dich_deck_en.py --ghi      # dựng ra slides-en/ và practice-en/

Đừng nhầm với scripts/dich_slide_en.py: tệp đó dịch bản ẢNH slide trong
assets/slides/ để hiện ngay trong trình xem của ứng dụng; tệp này dịch trọn
bộ .pptx nguồn để phát/lưu trữ dưới dạng PowerPoint, ra thư mục slides-en/ và
practice-en/ — hai việc khác nhau, tình cờ khởi điểm cùng tên nên phải tách.
